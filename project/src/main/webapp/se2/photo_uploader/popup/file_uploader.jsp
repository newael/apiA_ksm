...
/*  String path = "C:/dev/project/src/main/webapp/uploadimages";  // 이미지가 저장될 주소  */
String path = request.getSession().getServletContext().getRealPath("/") + File.separator +"uploadimages";   // 이미지가 저장될 주소
String filename = "";
